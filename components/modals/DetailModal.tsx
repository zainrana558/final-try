    ...
    >
      <div className="flex min-h-full items-start justify-center p-4 pt-12">
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute right-5 top-5 z-20 rounded-full p-2.5 transition-all duration-200 hover:bg-white/10"
              ...
              <div className="px-8 pt-6 pb-10 space-y-7">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <Button
                    ...
                    className="gap-2 rounded-xl px-6 py-3 font-semibold text-base"
                ...
                <div className="flex flex-wrap items-center gap-5 text-sm text-zinc-400">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="text-yellow-400 font-semibold text-base">{formatRating(details.vote_average)}</span>
                  </span>
                  <span className="flex items-center gap-1.5">
                ...
                {/* Tagline */}
                {details.tagline && (
                  <p className="text-base italic text-zinc-400 border-l-2 border-zinc-700 pl-4 leading-relaxed">
                ...
                {profileId && (
                  <div className="space-y-3">
                    <p className="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Your Rating</p>
                    <div className="flex items-center gap-1.5">
                      ...
                      {userRating && (
                        <span className="ml-3 text-sm text-zinc-500">{userRating}/10</span>
                      )}
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {details.credits.cast.slice(0, 10).map((member: CastMember) => (
                        <div key={member.id} className="flex-shrink-0 text-center" style={{ width: 80 }}>
                          <div
                          ...
                          <p className="mt-2 w-full truncate text-xs font-semibold text-zinc-200 leading-tight">
                            {member.name}
                          </p>
                          <p className="w-full truncate text-xs text-zinc-500 leading-tight">
                            {member.character}
                          </p>
                        </div>
                      ))}
